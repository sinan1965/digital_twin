...
------BAKIM-----------------------------
----------------------------------------
-- Bakım verilerinde primary key oluşturmak için arıza tarih ve saat kolonlarını birleştirmek için.

alter table gümüş.bakım_veri
add baş_saati datetime;

alter table gümüş.bakım_veri
add bit_saati datetime;

--Boş olan son satırı silmek için...
delete from gümüş.bakım_veri
where Arıza_Bakım is NULL;

--Bu işlem ilgili tarih kolonları stringden tarih saate çevrildikten sonra çalıştırılacak.
alter table gümüş.bakım_veri
add ay int;
...
----------------------------------------------------
--------FORKLİFT OFF SITE HISTORY-------------------
----------------------------------------------------

--Yapılması gerek bir dönüşüm yok.

--------------------------------------------------------------
---------FORKLIFT WORKING HOURS HISTORY-----------------------
--------------------------------------------------------------

-- Şimdi work_start_date ve work_start_hour kolonlarını birleştirmek ve yeni kolonlar oluşturmak için.
alter table gümüş.forklift_whh
add start_ts datetime;

alter table gümüş.forklift_whh
add finish_ts datetime;

---------------------------------------------------------------
-----------FORKLIFT ZONE PRESENCE HISTORY----------------------
---------------------------------------------------------------

-- Şimdi work_start_date1 ve start_time kolonlarını birleştirmek ve yeni kolonlar oluşturmak için.
alter table gümüş.forklift_zph
...
alter table gümüş.forklift_zph
add duration_sec int

---------------------------------------------
-----------OTOMASYON-------------------------
---------------------------------------------

alter table gümüş.otomasyon_veri
add ay int;
...
--Yapılması gerek bir dönüşüm yok.
--sp_columns 'sipariş_veri'

------------------------------------------
--------ÜRETİM----------------------------
------------------------------------------
--ay, hafta ve gün isimli kolonları eklenmesi
alter table gümüş.üretim_veri
add ay int;
